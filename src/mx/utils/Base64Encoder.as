package mx.utils
{
   ...
   public class Base64Encoder
   {
      ...
      public function encode(param1:String, param2:uint = 0, param3:uint = 0) : void
      {
         ...
         while(_loc5_ < _loc4_)
         {
            this._work[this._count] = param1.charCodeAt(_loc5_);
            ++this._count;
            if(this._count == this._work.length || _loc4_ - _loc5_ == 1)
            {
               this.encodeBlock();
               this._count = 0;
               this._work[0] = 0;
      ...
      public function encodeBytes(param1:ByteArray, param2:uint = 0, param3:uint = 0) : void
      {
         ...
         while(_loc6_ < _loc4_)
         {
            this._work[this._count] = param1[_loc6_];
            ++this._count;
            if(this._count == this._work.length || _loc4_ - _loc6_ == 1)
            {
               this.encodeBlock();
               this._count = 0;
               this._work[0] = 0;
