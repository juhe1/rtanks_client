package package_424
{
   ...
   public class NewsTab extends class_202
   {
      ...
      private var newsPanel:ScrollPane;
      ...
      public function NewsTab()
      {
         ...
         ScrollStyleUtils.setGreenStyle(this.newsPanel);
         this.newsPanel.horizontalScrollPolicy = ScrollPolicy.OFF;
         this.newsPanel.verticalScrollPolicy = ScrollPolicy.AUTO;
         this.newsPanel.source = this.var_2632;
         this.newsPanel.update();
         this.newsPanel.focusEnabled = false;
         this.newsPanel.addEventListener(MouseEvent.MOUSE_WHEEL,this.onMouseWheel,true);
         this.var_1182.addChild(this.newsPanel);
      ...
      private function onClick(param1:MouseEvent) : void
      {
         ...
         while(_loc5_ < this.var_2632.numChildren)
         {
            ...
            if(_loc2_ is NewsItem)
            {
               ...
               _loc4_ = _loc2_.y - (this.var_3127 ? this.newsPanel.verticalScrollPosition : 0);
      ...
      {
         if(!(this.var_2632.getChildAt(param1 - 1) is LabelBase))
         {
            return;
         }
         if(param1 == this.var_2632.numChildren || this.var_2632.getChildAt(param1) is LabelBase)
         {
      ...
      private function method_2251(param1:NewsServiceEvent) : void
      {
         ...
         {
            _loc2_ = this.var_2632.getChildAt(1) as LabelBase;
      ...
      private function method_2736(param1:int) : int
      {
         ...
         while(_loc6_ < this.var_2632.numChildren)
         {
            ...
            if(_loc2_ is LabelBase)
            {
               _loc4_ = LabelBase(_loc2_);
      ...
      public function destroy() : void
      {
         ...
         this.newsPanel.removeEventListener(MouseEvent.MOUSE_WHEEL,this.onMouseWheel);
