package package_157
{
   ...
   public class name_1807 extends class_30 implements name_657
   {
       
      
      private var var_170:name_175;
      
      private var smoke:name_2715;
      ...
      public function name_1807(param1:ObjectPool)
      {
         this.var_2528 = new Vector3();
         this.direction = new Vector3();
         super(param1);
         this.smoke = new name_2715();
      }
      ...
      public function init(param1:Vector3, param2:Vector3, param3:Material, param4:Number, param5:Number, param6:Number, param7:Number, param8:int) : void
      {
         ...
         this.smoke.init(param4,_loc9_,param3,param7);
         this.time = 0;
      }
      ...
      public function play(param1:int, param2:name_735) : Boolean
      {
         ...
         name_2500.name_2503(this.smoke,this.var_2528,this.direction,param2.pos);
         _loc4_ = this.time / this.var_2527;
         _loc3_ = Math.sqrt(_loc4_);
         this.smoke.scaleX = this.var_2529 + (this.var_2530 - this.var_2529) * _loc3_;
         this.smoke.alpha = 1 - _loc4_;
         this.smoke.update(_loc3_);
         this.time += param1;
         return true;
      }
