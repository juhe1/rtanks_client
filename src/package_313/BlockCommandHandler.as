package package_313
{
   ...
   public class BlockCommandHandler implements name_1350
   {
      ...
      public function method_885(param1:Array) : Boolean
      {
         ...
         LobbyChat.name_2155(_loc2_);
         var _loc3_:name_102 = name_102(Main.osgi.name_6(name_102));
         this.var_633.addSystemMessage(_loc3_.getText(TextConst.CHAT_PANEL_COMMAND_BLOCK,_loc2_));
         return true;
      }
   }
}
