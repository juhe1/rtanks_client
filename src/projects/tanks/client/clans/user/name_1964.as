package projects.tanks.client.clans.user
{
   ...
   public class name_1964
   {
      ...
      {
         Network(OSGi.getInstance().name_6(name_2)).send("clan;accept;" + param1.id);
      }
      
      public function add(param1:name_70) : void
      {
         Network(OSGi.getInstance().name_6(name_2)).send("clan;add;" + param1.id);
      }
      
      public function name_1980(param1:String) : void
      {
         Network(OSGi.getInstance().name_6(name_2)).send("clan;addInClanByName;" + param1);
      }
      
      public function name_1979(param1:String) : void
      {
         Network(OSGi.getInstance().name_6(name_2)).send("clan;checkClanName;" + param1);
      }
      
      public function method_1410(param1:name_70) : void
      {
         Network(OSGi.getInstance().name_6(name_2)).send("clan;reject;" + param1.id);
      }
      
      public function method_1411() : void
      {
         Network(OSGi.getInstance().name_6(name_2)).send("clan;rejectAll");
      }
      
      public function method_1413(param1:name_70) : void
      {
         Network(OSGi.getInstance().name_6(name_2)).send("clan;revoke;" + param1.id);
      }
   }
}
