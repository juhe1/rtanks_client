package controls.base
{
   ...
   import base.class_142;
   import controls.Label;
   import controls.name_1932;
   import controls.name_1936;
   ...
   public class class_143 extends class_142
   {
      ...
      public function class_143()
      {
         ...
         this.format = name_269.method_775(12);
         super();
         this.configUI();
         this.enable = true;
         tabEnabled = false;
      ...
      public function configUI() : void
      {
         ...
         this._label.embedFonts = name_269.method_774();
      ...
      public function setStyle(param1:String = "def") : void
      {
         ...
         var _loc3_:String = "button_" + param1 + "_";
         _loc2_ = "UP";
         this.var_1237.name_1933 = this.method_1469(_loc3_ + _loc2_ + "_LEFT");
         this.var_1237.name_1934 = this.method_1469(_loc3_ + _loc2_ + "_CENTER");
         this.var_1237.name_1935 = this.method_1469(_loc3_ + _loc2_ + "_RIGHT");
         _loc2_ = "OVER";
         this.var_1235.name_1933 = this.method_1469(_loc3_ + _loc2_ + "_LEFT");
         this.var_1235.name_1934 = this.method_1469(_loc3_ + _loc2_ + "_CENTER");
         this.var_1235.name_1935 = this.method_1469(_loc3_ + _loc2_ + "_RIGHT");
         _loc2_ = "DOWN";
         this.var_1238.name_1933 = this.method_1469(_loc3_ + _loc2_ + "_LEFT");
         this.var_1238.name_1934 = this.method_1469(_loc3_ + _loc2_ + "_CENTER");
         this.var_1238.name_1935 = this.method_1469(_loc3_ + _loc2_ + "_RIGHT");
         _loc2_ = "OFF";
         _loc3_ = "button_";
         this.var_1239.name_1933 = this.method_1469(_loc3_ + _loc2_ + "_LEFT");
         this.var_1239.name_1934 = this.method_1469(_loc3_ + _loc2_ + "_CENTER");
         this.var_1239.name_1935 = this.method_1469(_loc3_ + _loc2_ + "_RIGHT");
         this.width = 96;
      }
