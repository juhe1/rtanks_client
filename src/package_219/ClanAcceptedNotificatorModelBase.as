package package_219
{
   ...
   public class ClanAcceptedNotificatorModelBase extends Model
   {
      ...
      protected var server:name_1905;
      
      private var client:name_605;
      ...
      public function ClanAcceptedNotificatorModelBase()
      {
         ...
         this.client = name_605(this);
         this.var_25 = Long.getLong(1575927935,-367368112);
         this.var_1175 = Long.getLong(946943636,-1512579195);
         this.var_1176 = Long.getLong(709518332,1700494084);
         super();
         this.method_770();
      }
      ...
      {
         this.server = new name_1905(name_66(this));
      }
