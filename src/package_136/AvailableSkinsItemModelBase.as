package package_136
{
   ...
   public class AvailableSkinsItemModelBase extends Model
   {
      ...
      protected var server:name_2667;
      
      private var client:name_1648;
      ...
      public function AvailableSkinsItemModelBase()
      {
         ...
         this.client = name_1648(this);
         this.var_25 = Long.getLong(1212548768,-1645485380);
         super();
         this.method_770();
      }
      ...
      {
         this.server = new name_2667(name_66(this));
      }
      
      protected function method_771() : name_407
      {
         return name_407(var_19[Model.object]);
      }
