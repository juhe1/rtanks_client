package alternativa.physics
{
   ...
   public class name_660
   {
      ...
      public function name_660(param1:Number, param2:Matrix3, param3:Number)
      {
      ...
      public function method_443(param1:name_774, param2:Matrix4 = null) : void
      {
         if(param1 == null)
         {
      ...
      public function method_441(param1:name_774) : void
      {
         if(this.var_302 == null)
         {
            return;
