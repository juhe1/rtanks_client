package alternativa.tanks.vehicles.tanks
{
   ...
   public final class Turret implements WeaponMount
   {
      ...
      private static const const_1642:Number = MathUtils.method_604(0.5);
      ...
      {
         this.var_1724 = MathUtils.method_612(param1);
      }
      ...
      {
         var _loc2_:Number = MathUtils.method_614(this.var_1728,param1);
      ...
      private function method_1911(param1:Number) : void
      {
         ...
         else
         {
            ...
            this.var_1724 = MathUtils.method_612(this.var_1724 + this.turnSpeed * param1);
      ...
      {
         var _loc3_:Number = MathUtils.method_614(param2,this.var_1724);
         ...
         {
            this.var_1724 = MathUtils.method_612(this.var_1724 + _loc4_);
         }
         var _loc5_:Number = MathUtils.method_613(_loc3_);
      ...
      private function method_1910(param1:Number, param2:Number, param3:Number) : Number
      {
         ...
         return MathUtils.method_609(param1,param2 * _loc4_,this.turnAcceleration * param3);
      }
      ...
      public function var_165(param1:Body) : void
      {
         this.method_1912(param1);
      }
      
      private function method_1912(param1:Body) : void
      {
         ...
         if(this.var_1730 > 0)
         {
            ...
            this.var_1724 = MathUtils.method_612(this.var_1724 + _loc4_ * this.var_1730);
         }
      }
      ...
      public function interpolate(param1:Number, param2:int) : void
      {
         ...
         var _loc3_:Number = MathUtils.method_614(this.var_1724,this.var_1726);
         this.var_1728 = MathUtils.method_612(this.var_1726 + param1 * _loc3_ + this.spring.value);
      }
      ...
      public function reset() : void
      {
         ...
         this.var_1724 = 0;
         this.var_1728 = 0;
         this.var_1712.reset(this.var_1712.getTargetValue());
      ...
      public function name_201(param1:Number, param2:Boolean) : void
      {
         ...
         {
            this.var_1712.setTargetValue(param1);
         }
      }
