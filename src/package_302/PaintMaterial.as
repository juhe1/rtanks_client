package package_302
{
   ...
   public class PaintMaterial extends TextureMaterial
   {
      ...
      protected var var_2838:Vector.<Number>;
      
      private var programs:Dictionary;
      
      protected var var_2840:BitmapData;
      
      protected var var_2839:BitmapData;
      
      protected var var_2836:BitmapTextureResource;
      
      protected var var_2837:BitmapTextureResource;
      ...
      public function PaintMaterial(param1:BitmapData, param2:BitmapData, param3:BitmapData, param4:int = 0)
      {
         ...
         this.var_2836 = TextureResourcesRegistry.getTextureResource(param1,alternativa3d::_mipMapping > 0,true,false);
         this.var_2837 = TextureResourcesRegistry.getTextureResource(param2,alternativa3d::_mipMapping > 0,true,false);
         this.var_2838 = Vector.<Number>([0,0.5,1,2,0.999,0.999,0,0]);
         uvTransformConst[0] = param3.width / param1.width;
         uvTransformConst[5] = param3.height / param1.height;
         alternativa3d::_mipMapping = this.var_2836.mipMapping ? int(int(MipMapping.PER_PIXEL)) : int(int(0));
      }
      ...
      override public function set mipMapping(param1:int) : void
      {
         ...
         this.var_2836 = TextureResourcesRegistry.getTextureResource(this.var_2840,alternativa3d::_mipMapping > 0,true,false);
         this.var_2837 = TextureResourcesRegistry.getTextureResource(this.var_2839,alternativa3d::_mipMapping > 0,true,false);
      }
      ...
      override alternativa3d function drawOpaque(param1:Camera3D, param2:VertexBufferResource, param3:IndexBufferResource, param4:int, param5:int, param6:Object3D) : void
      {
         ...
         _loc8_.setTextureAt(4,this.var_2836);
         _loc8_.setTextureAt(6,this.var_2837);
         if(_loc13_)
         {
         ...
         _loc8_.setProgramConstantsFromVector(Context3DProgramType.FRAGMENT,23,this.var_2838,2,false);
      ...
      override alternativa3d function drawTransparent(param1:Camera3D, param2:VertexBufferResource, param3:IndexBufferResource, param4:int, param5:int, param6:Object3D, param7:Boolean = false) : void
      {
         ...
         _loc9_.setTextureAt(4,this.var_2836);
         _loc9_.setTextureAt(6,this.var_2837);
         if(_loc16_)
         {
         ...
         _loc9_.setProgramConstantsFromVector(Context3DProgramType.FRAGMENT,23,this.var_2838,2,false);
         if(_loc11_)
         {
      ...
      override public function disposeResource() : void
      {
         ...
         if(this.var_2836 != null)
         {
            this.var_2836.dispose();
            this.var_2836 = null;
         }
         if(this.var_2837 != null)
         {
