package package_223
{
   ...
   public class ClanIncomingNotificatorModelBase extends Model
   {
      ...
      protected var server:name_1943;
      
      private var client:name_638;
      ...
      public function ClanIncomingNotificatorModelBase()
      {
         ...
         this.client = name_638(this);
         this.var_25 = Long.getLong(1448266566,-1893699662);
         this.var_1175 = Long.getLong(47370739,-335983741);
         this.var_1176 = Long.getLong(1468492941,414226622);
         super();
         this.method_770();
      }
      ...
      {
         this.server = new name_1943(name_66(this));
      }
