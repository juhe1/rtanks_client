package assets.cellrenderer.battlelist
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="assets.cellrenderer.battlelist.class_206")]
   public class class_206 extends name_1932
   {
      ...
      {
         super();
         name_1933 = new cell_off_SELECTED_LEFT(1,1);
         name_1934 = new cell_off_SELECTED_CENTER(1,1);
         name_1935 = new cell_off_SELECTED_RIGHT(1,1);
      }
