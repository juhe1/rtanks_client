         ...
         switch(param1.type)
         {
            case name_346.CLAN:
               if(param1.name_319[0] == "init")
               {
                  ...
                  name_52(OSGi.getInstance().name_6(name_52)).clanMember = _loc3_.clanMember;
                  ...
                  name_65(OSGi.getInstance().name_6(name_65)).userObject = this.space.name_15(Long.getLong(0,31835),var_72.createClass(Long.getLong(0,23845),_loc2_),"UserObject");
